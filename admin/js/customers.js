				...
				if (resp.status == 202) {
					...
					$.each(resp.message, function(index, value){
						...
						customersHTML += '<tr>'+
											  ...
											  '<td><a class="btn btn-sm btn-info edit-category">Edit<span style="display:none;">'+JSON.stringify(value)+'</span><i class="fas fa-pencil-alt"></i></a>&nbsp;<a cid="'+value.user_id+'" class="btn btn-sm btn-danger delete-category">Delete<i class="fas fa-trash-alt"></i></a></td>'+
									       '</tr>'
